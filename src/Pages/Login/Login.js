        ...
        <>
            ...
            <div className="flex justify-center items-center min-h-screen">
                <div className="w-5/6 md:w-1/4 border-2 rounded px-10 pt-5 pb-5 mt-5">
                    <h3 className="text-3xl mb-5">Login to account</h3>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className="bg-primary w-full px-4 py-3 rounded text-white cursor-pointer	" type="submit" value="Login" />
                    </form>
                    <Link to="/register">
                        <p className="text-lg font-mediums text-primary text-center my-6 hover:underline">Need an account ?</p>
                    </Link>
